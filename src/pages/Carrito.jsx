    ...
    if (cartItems.length === 0) {
        return (
            <div className="container mt-5 pt-5 text-center">
                ...
                <p className="text-muted">Parece que aún no has añadido nada a tu carrito de compras.</p>
        ...
        <div className="container my-5">
            ...
            <div className="row">
                            ...
                            {cartItems.map(item => {
                                ...
                                <div key={item.product.id} className="row align-items-center border-bottom py-3">
                                    ...
                                    <div className="col-md-5 d-flex align-items-center">
                                        <img src={item.product.imagen || '/images/placeholder.png'} alt={item.product.nombre} className="img-fluid me-3 rounded" style={{ width: '60px', height: '60px', objectFit: 'cover' }} />
                                        <div>
                ...
                <div className="col-lg-4">
                    <div className="card shadow-lg border-0 sticky-top" style={{ top: '80px' }}>
                        <div className="card-body">
                            <h4 className="card-title fw-bolder mb-4 border-bottom pb-2">Resumen del Pedido</h4>
                            ...
                            <Link to="/checkout" className="btn btn-success w-100 fw-bold py-2">
                                Procesar Compra <i className="bi bi-arrow-right-circle-fill ms-2"></i>
                            </Link>
