...
return (
    ...
    <p>
        ...
        de los productos del campo directamente a la puerta de nuestros clientes
        en Chile. Con más de 6 años de experiencia, operamos en más de 9 puntos
        a lo largo del país, incluyendo ciudades clave como Santiago, Puerto
        Montt, Villarica, Nacimiento, Viña del Mar, Valparaíso, y Concepción.
    ...
    <p>
        ...
        garantizando la frescura y el sabor en cada entrega. Nos comprometemos a
        fomentar una conexión más cercana entre los consumidores y los
    ...
    <p>
        ...
        estableciendo un nuevo estándar en la distribución de productos
        agrícolas directos del productor al consumidor.
    </p>
