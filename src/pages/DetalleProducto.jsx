...
const manejarAgregarAlCarrito = () => {
    ...
    console.log(
        `[Detalle] Añadido ${cantidad}x ${producto.nombre} al carrito.`
    );
    }
};
...
return (
    ...
    <div className="row g-5">
        ...
        <div className="d-flex align-items-center mb-4 border-bottom pb-3">
            <span className="text-success fw-bolder display-6 me-4">
        ...
        <div className="d-flex align-items-center gap-3 mt-4 p-3 border rounded-3 bg-light">
            ...
            onChange={(e) =>
                setCantidad(
                Math.max(1, Math.min(stockDisponible, Number(e.target.value)))
                )
            }
            />
