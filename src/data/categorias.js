export const categorias = [
  {
    ...
    link: "/productos?categoria=FR",
  },
  {
    id: "VR",
    imagen: "",
    nombre: "Verduras Orgánicas",
    descripcion: "Descubre nuestra gama de verduras orgánicas, cultivadas sin el uso de pesticidas ni químicos, garantizando un sabor auténtico y natural. Cada verdura es seleccionada por su calidad y valor nutricional, ofreciendo una excelente fuente de vitaminas, minerales y fibra.",
    link: "/productos?categoria=VR",
  },
  {
    id: "PO",
    imagen: "",
    ...
    link: "/productos?categoria=PO",
  },
  {
    id: "PL",
    imagen: "",
    nombre: "Productos Lácteos",
    descripcion: "Los productos lácteos de HuertoHogar provienen de granjas locales dedicadas a la producción responsable y de calidad. Ofrecemos una gama de leches, yogures y derivados que conservan su frescura y sabor auténtico.",
    link: "/productos?categoria=PL",
  },
];
